...
const columnTitle =
  "mb-3 font-mono text-[0.7rem] uppercase tracking-[0.18em] text-clay-light";
...
export function SiteFooter({ settings }: { settings: SiteSettings }) {
  return (
    <footer className="border-t border-cocoa-line bg-cocoa text-cream/85">
      <div className="mx-auto grid max-w-page gap-10 px-5 py-14 sm:grid-cols-2 sm:px-8 lg:grid-cols-4">
        <div className="max-w-xs">
          ...
          <p className="mt-3 text-sm text-cream/65">{site.tagline}</p>
            ...
            {site.social.map((account) => {
              ...
              return (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-cocoa-line text-cream/70 transition-colors hover:border-cream hover:text-cream"
                >
      ...
      <div className="border-t border-cocoa-line/70">
        <div className="mx-auto flex max-w-page flex-col gap-3 px-5 py-6 text-xs text-cream/60 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          <p>
